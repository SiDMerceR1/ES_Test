...
public class VehicleService {
	...
	public List<Vehicle> getAllVehiclesCreatedBetween(final Date date1, final Date date2) {
		final SearchRequest request = SearchUtil.buildSearchRequest(Indices.VEHICLE_INDEX, "created", date1, date2);
